...
const std::array<double, 3>& Point3D::getCoordinates() const {
    return coordinates_;
}

// Implementacja klasy APointCloud
APointCloud::APointCloud() : points_(new std::array<Point3D, 100>), count_(0) {}
