...
void Decay_4CM(){
    ...
    TRandom3 randGen;
    TH2F* hist1 = new TH2F("hist1", "#Phi_{1}^{CM}(P) K^{-}", 100, 0, 0.2, 100, 0,3.5);
    TH2F* hist2 = new TH2F("hist2", "#Phi_{2}^{CM}(P) #pi^{0}", 100, 0, 0.2, 100, 0,3.5);
    TH2F* hist3 = new TH2F("hist3", "#Phi_{3}^{CM}(P) = #Phi_{1} - #Phi_{2}", 100, 0, 0.2, 100, 0,3.5);
